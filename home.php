          ...
          <div class="slider-inner h-100">
            <div class="row align-items-center h--100">
              <div class="col-xl-6 col-lg-12 col-md-12">
                ...
                Khi Tony Stark và Bruce Banner cố gắng khởi động lại một
                chương trình gìn giữ hòa bình đang ngủ yên có tên là Ultron, mọi thứ trở nên tồi tệ
                và những anh hùng bóng đêm nhất của Trái đất phải ngăn chặn
                tên phản diện Ultron thực hiện kế hoạch khủng khiếp của hắn.
                </p>
                <div class="trending-list" data-animation-in="fadeInUp" data-delay-in="1.2">
                  ...
                  <div class="text-primary title genres">
                    Thể loại : <span class="text-body">Hành động</span>
                  </div>
                  <div class="text-primary title tag">
                    Tags :
                    <span class="text-body">Hành động, phiêu lưu</span>
                  </div>
                </div>
              ...
              <div class="col-xl-6 col-lg-12 col-md-12">
                ...
                <div class="d-flex flex-wrap align-items-center fadeInLeft animated" data-animation-in="fadeInLeft"
                  ...
                  <div class="slider-ratting d-flex align-items-center mr-4 mt-2 mt-md-3">
                    ...
                    <span class="text-white ml-2">7.4(đánh giá)</span>
                  </div>
                  <div class="d-flex align-items-center mt-2 mt-md-3">
                    <span class="badge badge-secondary p-2">13+</span>
                    <span class="ml-3">1h 24p</span>
                  </div>
                </div>
                <p data-animation-in="fadeInUp">
                Khi Nữ hoàng Elsa mới đăng quang vô tình sử dụng sức mạnh của mình để biến mọi thứ thành băng để 
                nguyền rủa ngôi nhà của cô vào mùa đông vô tận, em gái Anna của cô đã hợp tác với một người đàn ông 
                miền núi, chú tuần lộc vui tươi của anh ta và một người tuyết để thay đổi điều kiện thời tiết.
                </p>
                <div class="trending-list" data-animation-in="fadeInUp" data-delay-in="1.2">
                  <div class="text-primary title starring">
                    Diễn viên:
                  ...
                  <div class="text-primary title genres">
                    Thể loại : <span class="text-body">Hoạt hình</span>
                  </div>
                  <div class="text-primary title tag">
                    Tags :
                    <span class="text-body">Hài hước, hoạt hình</span>
                  </div>
                </div>
                <div class="d-flex align-items-center r-mb-23 mt-4" data-animation-in="fadeInUp" data-delay-in="1.2">
                  <a href="#" class="btn btn-hover iq-button"><i class="fa fa-play mr-3"></i>Xem ngay</a>
              ...
              <div class="col-xl-6 col-lg-12 col-md-12">
                ...
                <div class="d-flex flex-wrap align-items-center fadeInLeft animated" data-animation-in="fadeInLeft"
                  ...
                  <div class="slider-ratting d-flex align-items-center mr-4 mt-2 mt-md-3">
                    ...
                    <span class="text-white ml-2">7.5(đánh giá)</span>
                  </div>
                  <div class="d-flex align-items-center mt-2 mt-md-3">
                    <span class="badge badge-secondary p-2">16+</span>
                    <span class="ml-3">1h 52p</span>
                  </div>
                </div>
                <p data-animation-in="fadeInUp">
                Hai nhà điều tra hiện tượng huyền bí Ed và Lorraine Warren nỗ lực giúp đỡ một gia đình đang
                bị thế lực đen tối đe dọa trong trang trại của họ.
                </p>
                <div class="trending-list" data-animation-in="fadeInUp" data-delay-in="1.2">
                  <div class="text-primary title starring">
                    Diễn viên :
                  ...
                  <div class="text-primary title genres">
                    Thể loại : <span class="text-body">Kinh dị</span>
                  </div>
                  <div class="text-primary title tag">
                    Tags :
        ...
        <div class="row">
          <div class="col-sm-12 overflow-hidden">
            <div class="iq-main-header d-flex align-items-center justify-content-between">
              <h4 class="main-title">Gợi ý cho bạn</h4>
                  ...
                  <div class="block-images position-relative">
                    ...
                    <div class="block-description">
                      ...
                      <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <span class="text-white">1h 43p</span>
                      </div>
                      <div class="hover-buttons">
                        <span class="btn btn-hover iq-button" onclick="window.location.href='xemphim.php?id=1'">
